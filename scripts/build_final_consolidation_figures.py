...
ax.set_title("Ablation summary: Primary PR-AUC, all configurations\n(green=5-seed full evaluation, red=2-seed pilot)", fontsize=11)
...
ax.set_title("Ablation summary: Severity PR-AUC, all configurations\n(green=5-seed full evaluation, red=2-seed pilot)", fontsize=11)
ax.legend(loc="lower right", fontsize=8)
...
axes[0].set_xticks([42, 43, 44, 45, 46])
...
axes[1].set_xticks([42, 43, 44, 45, 46])
axes[1].legend()
