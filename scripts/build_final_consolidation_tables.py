...
ROWS = [
    ...
    dict(phase="Phase 4 Stage 1", experiment="Representation diagnostic: Logistic Regression", configuration="raw 128D frozen embedding, sklearn LogisticRegression",
         split="primary", n_seeds=5, seed_type="full",
         pr_auc=0.671, pr_auc_std=0.043, roc_auc=0.966, f1=None, precision=None, recall=None,
         specificity=None, balanced_accuracy=None, mcc=None, brier=None, ece=None,
         decision="Supported contributor to understanding (representation contains signal)", source="QGNN_V4_PHASE4_RESULTS.md (Stage 1) A1"),
    dict(phase="Phase 4 Stage 1", experiment="Representation diagnostic: Logistic Regression", configuration="raw 128D frozen embedding, sklearn LogisticRegression",
         split="severity", n_seeds=5, seed_type="full",
         pr_auc=0.465, pr_auc_std=0.005, roc_auc=0.731, f1=None, precision=None, recall=None,
         specificity=None, balanced_accuracy=None, mcc=None, brier=None, ece=None,
         decision="Supported contributor to understanding (matches/exceeds QGNN+classical on severity)", source="QGNN_V4_PHASE4_RESULTS.md (Stage 1) A1"),
